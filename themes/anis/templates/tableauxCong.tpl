...
<td class="date{$tab[$onglet.param][$user->uid()][$smarty.section.vac.index]['classe']}" id="u{$user->uid()}d{$tab[$onglet.param][$user->uid()][$smarty.section.vac.index]['date']}"><a href="?uid={$user->uid()}&amp;param={$tab[$onglet.param][$user->uid()][$smarty.section.vac.index]['date']}">{$tab[$onglet.param][$user->uid()][$smarty.section.vac.index]['date']}</a></td>
{/section}
</tr>
{/foreach}
</table>
