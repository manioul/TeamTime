...
<select name="{$select.name}"{if isset($select.id)} id="{$select.id}"{/if}{if isset($select.multiple)} multiple="multiple"{/if}{if isset($select.onchange)} onchange="{$select.onchange}"{/if}>
