...
CREATE TABLE `TBL_CYCLE` (
  ...
  `team` varchar(10) NOT NULL,
  PRIMARY KEY (`cid`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='Description du cycle de travail';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `TBL_HEURES` (
  ...
  `statut` enum('fixed','shared','unattr') CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT 'unattr',
...
CREATE TABLE `TBL_PHONE` (
  ...
  PRIMARY KEY (`phoneid`)
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8 COMMENT='Tables des numéro de téléphone des utilisateurs';
/*!40101 SET character_set_client = @saved_cs_client */;
