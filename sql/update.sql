...
BEGIN
	...
	ALTER TABLE `TBL_VACANCES_RECAP` CHANGE `uid` `uid` SMALLINT NOT NULL, ADD KEY `uid` (`uid`), ADD CONSTRAINT `TBL_VACANCES_RECAP_ibfk_1` FOREIGN KEY (`uid`) REFERENCES `TBL_USERS` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE;
